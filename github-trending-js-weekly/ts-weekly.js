...
const URL = 'https://github.com/trending/typescript?since=weekly'
// const TESTURL = 'http://127.0.0.1:5500/test-data/github.html'
let MarkDownFile = '# [GitHub] TypeScript 趋势榜项目(第xx周)'
...
`
  ...
  // 写入文件
  fs.writeFile('github-ts-weekly.md', MarkDownFile, (err) => {
    if (!err) {
      console.log('文件写入完成')
    }
  })
